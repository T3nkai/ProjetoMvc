...
public interface IControladorChamados {
     ...
     */
    int getTotalChamadosPorTipo(ITipoChamado tipo);
     ...
     */
    IChamado incluiChamado(Date data, Cliente cliente, Tecnico tecnico, String titulo, String descricao, int prioridade, ITipoChamado tipo);
